...
class DirectDepotAssessmentDialogA23(DirectDepotAssessmentDialogA22):
    """v0.1.6-a3: route direct assessment to searchable archive-part review."""
    ...
    def _open_result_views(self) -> None:
        ...
        dialog = DepotResultViewsDialogA23(
            self,
