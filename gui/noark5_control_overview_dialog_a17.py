...
class Noark5ControlOverviewDialogA17(Noark5ControlOverviewDialogA16):
    def _open_assessment(self, report_path: Path | None) -> None:
        ...
        if existing is not None:
            try:
                ...
                pass
        dialog = DirectDepotAssessmentDialogA17(self, report_path=report_path, user_identity=self.user_identity)
