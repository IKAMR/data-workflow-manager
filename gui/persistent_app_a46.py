...
from . import theme
from .direct_depot_assessment_dialog_a14 import DirectDepotAssessmentDialogA14
from .noark5_control_overview_dialog_a14 import Noark5ControlOverviewDialogA14
from .persistent_app_a45 import WorkflowApp as A45WorkflowApp


class WorkflowApp(A45WorkflowApp):
    """v0.1.4-a14: human-readable Arkade 5 report analysis."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        dialog = Noark5ControlOverviewDialogA14(
            parent,
    ...
    def _open_depot_assessment(self) -> None:
        ...
        if report_path is None:
            ...
            dialog = DirectDepotAssessmentDialogA14(
                self,
