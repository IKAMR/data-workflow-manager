...
from . import theme
from .direct_depot_assessment_dialog_a16 import DirectDepotAssessmentDialogA16
from .noark5_control_overview_dialog_a16 import Noark5ControlOverviewDialogA16
from .persistent_app_a47 import WorkflowApp as A47WorkflowApp


class WorkflowApp(A47WorkflowApp):
    """v0.1.5-a6: combined DWM/Arkade coverage in depot result views."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        dialog = Noark5ControlOverviewDialogA16(
            parent,
    ...
    def _open_depot_assessment(self) -> None:
        ...
        if report_path is None:
            ...
            dialog = DirectDepotAssessmentDialogA16(
                self,
