...
class DirectDepotAssessmentDialogA28(DirectDepotAssessmentDialogA27):
    """v0.1.6-a8: route direct assessment to sortable archive-part queue."""
    ...
    def _open_result_views(self) -> None:
        ...
        dialog = DepotResultViewsDialogA28(
            self,
