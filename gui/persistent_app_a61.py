...
from .depot_assessment_dialog_a21 import DepotAssessmentDialogA21
...
from .persistent_app_a60 import WorkflowApp as A60WorkflowApp


class WorkflowApp(A60WorkflowApp):
    """v0.1.5-a27: activate readable gap/overlap result views."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        dialog = Noark5ControlOverviewDialogA21(
            parent,
    ...
    def _open_depot_assessment(self) -> None:
        ...
        if report_path is None:
            dialog = DepotAssessmentDialogA21(
                self,
                user_identity=self.current_user_identity(),
                work_operations=work_operations,
            )
        else:
            dialog = DirectDepotAssessmentDialogA21(
                self,
