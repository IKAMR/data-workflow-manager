...
from .noark5_control_overview_dialog_a20 import Noark5ControlOverviewDialogA20
from .persistent_app_a59 import WorkflowApp as A59WorkflowApp


class WorkflowApp(A59WorkflowApp):
    """v0.1.5-a25: authoritative routing to simplified Noark 5 result views."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        dialog = Noark5ControlOverviewDialogA20(
            parent,
    ...
    def _open_depot_assessment(self) -> None:
        ...
        if report_path is None:
            dialog = DepotAssessmentDialogA20(
                self,
                user_identity=self.current_user_identity(),
