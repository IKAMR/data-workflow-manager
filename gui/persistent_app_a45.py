...
from .noark5_control_overview_dialog_a13 import Noark5ControlOverviewDialogA13
from .persistent_app_a44 import WorkflowApp as A44WorkflowApp


class WorkflowApp(A44WorkflowApp):
    """v0.1.4-a13: external test results as reusable resources."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        dialog = Noark5ControlOverviewDialogA13(
            parent,
