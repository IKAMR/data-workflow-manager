...
from .persistent_app_a50 import WorkflowApp as A50WorkflowApp


class WorkflowApp(A50WorkflowApp):
    """v0.1.5-a10: DWM/Arkade static gap and overlap presentation."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        if self.jobs_window is not None:
            try:
                ...
                pass
        dialog = Noark5ControlOverviewDialogA19(
    ...
    def _open_depot_assessment(self) -> None:
        ...
        if report_path is None:
            ...
            dialog = DirectDepotAssessmentDialogA19(self, report_path=report_path, user_identity=self.current_user_identity())
