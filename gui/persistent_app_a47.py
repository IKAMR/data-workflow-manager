...
from .noark5_control_overview_dialog_a15 import Noark5ControlOverviewDialogA15
from .persistent_app_a46 import WorkflowApp as A46WorkflowApp

class WorkflowApp(A46WorkflowApp):
    """v0.1.4-a15: reusable report export foundation."""
    ...
    def _open_validation_overview(self)->None:
        ...
        dialog=Noark5ControlOverviewDialogA15(
            parent,overview_json=json_path,overview_html=html_path,
    ...
    def _open_depot_assessment(self)->None:
        ...
        if report_path is None:
            ...
            dialog=DirectDepotAssessmentDialogA15(
                self,report_path=report_path,user_identity=self.current_user_identity()
            )
