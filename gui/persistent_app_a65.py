...
from .depot_assessment_dialog_a25 import DepotAssessmentDialogA25
from .direct_depot_assessment_dialog_a25 import DirectDepotAssessmentDialogA25
from .noark5_control_overview_dialog_a25 import Noark5ControlOverviewDialogA25
from .persistent_app_a64 import WorkflowApp as A64WorkflowApp


class WorkflowApp(A64WorkflowApp):
    """v0.1.6-a5: activate archive-part materialization status/navigation."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        dialog = Noark5ControlOverviewDialogA25(
            parent,
    ...
    def _open_depot_assessment(self) -> None:
        ...
        if report_path is None:
            dialog = DepotAssessmentDialogA25(
                self,
                user_identity=self.current_user_identity(),
                work_operations=work_operations,
            )
        else:
            dialog = DirectDepotAssessmentDialogA25(
                self,
