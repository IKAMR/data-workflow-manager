...
class DirectDepotAssessmentDialogA18(DirectDepotAssessmentDialogA17):
    """v0.1.5-a8: route result views to portable evidence export layer."""
    ...
    def _open_result_views(self) -> None:
        ...
        dialog = DepotResultViewsDialogA18(
            self,
