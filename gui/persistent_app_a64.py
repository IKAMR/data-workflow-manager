...
from .depot_assessment_dialog_a24 import DepotAssessmentDialogA24
from .direct_depot_assessment_dialog_a24 import DirectDepotAssessmentDialogA24
from .noark5_control_overview_dialog_a24 import Noark5ControlOverviewDialogA24
from .persistent_app_a63 import WorkflowApp as A63WorkflowApp


class WorkflowApp(A63WorkflowApp):
    """v0.1.6-a4: activate native-window and richer archive-part review."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        dialog = Noark5ControlOverviewDialogA24(
            parent,
    ...
    def _open_depot_assessment(self) -> None:
        ...
        if report_path is None:
            dialog = DepotAssessmentDialogA24(
                self,
                user_identity=self.current_user_identity(),
