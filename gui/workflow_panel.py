...
class WorkflowPanel(ctk.CTkFrame):
    ...
    def refresh(self) -> None:
        ...
        for row, op_id in enumerate(ids):
            ...
            up.grid(row=0, column=col, padx=2, pady=5)
            ...
            down.grid(row=0, column=col, padx=2, pady=5)
            ...
            if self.on_rerun is not None:
                ...
                rerun.grid(row=0, column=col, padx=2, pady=5)
            ...
            self._add_tooltip(btn, "Fjern operasjonen fra workflow")
