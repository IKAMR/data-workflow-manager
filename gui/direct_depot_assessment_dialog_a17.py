...
class DirectDepotAssessmentDialogA17(DirectDepotAssessmentDialogA16):
    def _open_result_views(self) -> None:
        ...
        if existing is not None:
            try:
                ...
                pass
        dialog = DepotResultViewsDialogA17(self, model=self.report_model, report_path=self.report_path, user_identity=self.user.as_dict() if self.user else None)
