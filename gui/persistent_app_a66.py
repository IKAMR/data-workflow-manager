...
from .noark5_control_overview_dialog_a26 import Noark5ControlOverviewDialogA26
from .persistent_app_a65 import WorkflowApp as A65WorkflowApp


class WorkflowApp(A65WorkflowApp):
    """v0.1.6-a6: activate screen-aware Noark 5 result review."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        dialog = Noark5ControlOverviewDialogA26(
            parent,
    ...
    def _open_depot_assessment(self) -> None:
        ...
        if report_path is None:
            dialog = DepotAssessmentDialogA26(
                self,
                user_identity=self.current_user_identity(),
                work_operations=work_operations,
            )
        else:
            dialog = DirectDepotAssessmentDialogA26(
                self,
