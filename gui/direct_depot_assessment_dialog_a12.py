...
from .depot_result_views_a12 import DepotResultViewsDialogA12


class DirectDepotAssessmentDialogA12(DirectDepotAssessmentDialogA11):
    def _open_result_views(self) -> None:
        ...
        dialog = DepotResultViewsDialogA12(
            self,
