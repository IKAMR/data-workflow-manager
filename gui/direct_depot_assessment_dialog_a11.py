...
from .direct_depot_assessment_dialog import DirectDepotAssessmentDialog
from .depot_result_views_a11 import DepotResultViewsDialogA11


class DirectDepotAssessmentDialogA11(DirectDepotAssessmentDialog):
    def _open_result_views(self) -> None:
        ...
        dialog = DepotResultViewsDialogA11(
            self,
