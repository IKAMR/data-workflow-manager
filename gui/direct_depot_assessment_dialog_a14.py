...
from .depot_result_views_a14 import DepotResultViewsDialogA14


class DirectDepotAssessmentDialogA14(DirectDepotAssessmentDialogA13):
    def _open_result_views(self) -> None:
        ...
        dialog = DepotResultViewsDialogA14(
            self,
