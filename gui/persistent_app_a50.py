...
from .persistent_app_a49 import WorkflowApp as A49WorkflowApp


class WorkflowApp(A49WorkflowApp):
    """v0.1.5-a8: portable Arkade 5 evidence export."""
    ...
    def _open_validation_overview(self) -> None:
        ...
        dialog = Noark5ControlOverviewDialogA18(
            parent,
